...
const Soon = lazy(() => import('./pages/SoonPage'));
      ...
      <div id="content">
        ...
        >
          <Switch>
            ...
            <Route path="/landing" exact={true} render={renderLandingPage} />
            <Route path="/" exact={true} render={renderSoonPage} />
